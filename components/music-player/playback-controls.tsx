...
export function PlaybackControls({ currentMix }: PlaybackControlsProps) {
  ...
  const totalDuration =
    currentMix?.sections.reduce((total, section) => {
      const sectionDuration = section.customInterval
        ? section.customInterval.end - section.customInterval.start
      ...
      <div className="flex items-center gap-6">
          ...
          {currentSection ? (
            <div className="space-y-1">
              ...
              <p className="text-sm text-muted-foreground truncate">
                {currentSection.song.artist} • Section {currentSectionIndex + 1}{" "}
                of {currentMix?.sections.length}
              </p>
            </div>
          ) : (
            <div className="space-y-1">
        ...
        <div className="flex items-center gap-2">
          ...
          <Button
            ...
            disabled={
              !currentMix ||
              currentSectionIndex === (currentMix?.sections.length || 0) - 1
            }
          >
